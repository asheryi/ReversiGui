...
import gui.graphicboard.GraphicBoard;
...
public class GameController implements Initializable, Display {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        boardContainer_.getChildren().remove(graphicBoard);
    ...
    //Saving the menu a load up not load menu more than once run per execution
